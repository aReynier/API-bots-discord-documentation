...
| Members_informations    | `firstname_member_informations`    | text   | "Jean"                                 | Prénom du membre Discord                                     |
| Members_informations    | `lastname_member_informations`     | text   | "Dupont"                               | Nom de famille du membre Discord                             |
| Members_informations    | `email__member_informations`       | text   | "jean.dupont@example.com"              | Adresse email du membre Discord                              |
| discord_users           | `id_discord`                       | text   | "123456789012345678"                   | Identifiant unique du membre Discord                         |
| discord_users           | `discord_user_name`                | text   | "JeanDupont#1234"                      | Nom d'utilisateur du membre Discord                          |
...
| Promotions              | `name_promation`                   | text   | "CDA-vals-p4"                          | nom de la promotion                                          |
...
| Courses                 | `id_courses`                       | text   | "123456789012345678"                   | identifiant unique de la formation                           |
